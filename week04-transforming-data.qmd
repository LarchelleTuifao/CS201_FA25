...
average_flipper_length <- penguins %>%
  group_by(species) %>%
...
ggplot(data = average_flipper_length, aes (x = species, y = average_flipper_length, fill = species)) +
  ...
  labs(title = "TITLE", subtitle = "subtitle", x = "flipper_length", y = "species")
```
...
average_culmen_depth <- penguins_data %>%
  group_by(species) %>%
  summarize(average_culmen_depth = mean(culmen_depth_mm, na.rm = TRUE))
...
ggplot(data = average_culmen_depth, aes (x = species, y = average_culmen_depth, fill = species)) +
  ...
  coord_flip() +
  theme(legend.position = "none") +
  labs(title = "Depth of Culmen", subtitle = "average of culmen_depth_mm", x = "flipper_length", y = "species")
```
