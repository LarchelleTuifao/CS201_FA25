...
-   Box: 25%-75% IQR - percentile of your data

-   Whiskers: 1.5\*5 % of your data
...
-   Where do we see a lot of variability?
    ...
    -   According to the graphs, it seems to be that the reason the ideal (best) cut diamonds are lower priced than the fair (least best) cut diamonds is because the size of the carat. The ideal cut diamonds come usually in a smaller size compared to the fair cut diamonds that are cut larger. And due to the fact that a fair cut diamond essentially would be cheaper than the ideal cut diamond, a customer would be more drawn to the larger for cheaper option. Because essentially the diamonds look the same.

-   Is there a relationship between carat and cut? yes, the bigger the carat, the more it costs.

-   Which category has the largest carat diamonds? fair
